      ...
      <div class="container z-10">
        <div class="flex flex-wrap justify-center -mx-3">
          <div class="w-full max-w-full px-3 mx-auto mt-0 text-center lg:flex-0 shrink-0 lg:w-5/12">
            <h1 class="mt-12 mb-2 text-white">Bienvenu!</h1>
            <p class="text-white">Creer un compte utilisateur pour acceder aux offres et promotion accordées uniquement pour les membres.</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="w-full max-w-full px-3 mx-auto mt-0 md:flex-0 shrink-0 md:w-7/12 lg:w-5/12 xl:w-4/12">
          <div class="relative z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
            ...
            <div class="flex-auto p-6">
              <form role="form text-left" action="{{ route('register') }}" method="POST" id="register_form">
                @csrf
                <div class="mb-4">
                  <x-input label="Nom complet" name="name" placeholder="Nom complet" aria-label="Name" aria-describedby="email-addon"/>
                  {{--<input type="text" id="name" name="name" class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" placeholder="Nom Complet" aria-label="Name" aria-describedby="email-addon"/>
                   <divclass="invalid_feedback"></div> --}}
                </div>
                <div class="mb-4">
                  <x-input label="Email" type="email" name="email" placeholder="xyz@domain.com" aria-label="Email" aria-describedby="email-addon"/>
                ...
                <div class="mb-4">
                  <x-input label="Mot de passe" type="password" name="password" placeholder="***********" aria-label="Password" aria-describedby="password-addon"/>
                  {{--<input type="password" id="password" name="password" class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" placeholder="Mot de passe" aria-label="Password" aria-describedby="password-addon"/>
                   <divclass="invalid_feedback"></div> --}}
                </div>
                <div class="mb-4">
                  <x-input label="Mot de passe" type="password" name="password_confirmation" placeholder="***********" aria-label="Password" aria-describedby="password-addon"/>
                  {{--<input type="password" id="cpass" name="password_confirmation" class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow" placeholder="COnfirmation du mot de passe" aria-label="Password" aria-describedby="password-addon"/>
                  <divclass="invalid_feedback"></div> --}}
                </div>
                <div class="min-h-6 pl-6.92 mb-0.5 block">
                  ...
                  <label class="mb-2 ml-1 font-normal cursor-pointer select-none text-sm text-slate-700" for="terms"> J'accepte <a href="javascript:;" class="font-bold text-slate-700"> les termes et les condition</a> </label>
                </div>
                <div class="text-center">
                  <button type="submit" id="btn_register" name="btn_register" class="inline-block w-full px-6 py-3 mt-6 mb-2 font-bold text-center text-white uppercase align-middle transition-all bg-transparent border-0 rounded-lg cursor-pointer active:opacity-85 hover:scale-102 hover:shadow-soft-xs leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 bg-gradient-to-tl from-gray-900 to-slate-800 hover:border-slate-700 hover:bg-slate-700 hover:text-white">S'inscrire</button>
                </div>
                <p class="mt-4 mb-0 leading-normal text-sm">Vous avez dejà un compte ? <a href="{{ route('login') }}" class="font-bold text-slate-700">Se connecter</a></p>
              </form>
            </div>
          </div>
        </div>
