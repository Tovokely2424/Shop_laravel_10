            ...
            <div class="relative flex flex-col min-w-0 mt-32 break-words bg-transparent border-0 shadow-none rounded-2xl bg-clip-border">
              ...
              <div class="flex-auto p-6">
                <form role="form" action="{{ route('login') }}" method="POST">
                  ...
                  <x-input name="email" label="Email" type="email" placeholder="Email" aria-label="Email" aria-describedby="email-addon"/>
                  <x-input name="password" label="Password" type="password" placeholder="Password" aria-label="Password" aria-describedby="password-addon"/>
