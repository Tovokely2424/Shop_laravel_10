...
<html lang="en" >
  ...
  <body class="m-0 font-sans text-base antialiased font-normal leading-default bg-gray-50 text-slate-500">
    ...
    <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
      ...
      <div class="items-center block w-auto overflow-auto  max-h-screen h-sidenav grow basis-full  border-2 border-red-500">
        <ul class="flex flex-col pl-0 mb-0">
          <li class="mt-0.5 w-full">
            <a class="py-2.7 shadow-soft-xl bg-white rounded-lg  font-semibold text-slate-700 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="../pages/dashboard.html">
          ...
          <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4  transition-colors" href="../pages/tables.html">
          ...
          <li class="mt-0.5 w-full">
            ...
            @class([
                  ...
                  'shadow-soft-xl bg-white  font-semibold text-slate-700 rounded-lg' => Route::is('table'),
                  ])
            href="{{ route('table', ['model' => 'App\Models\User']) }}">
              <div @class([
                  ...
                  'bg-gradient-to-tl from-purple-700 to-pink-500' =>Route::is('table'),
                  ])
              >
            ...
            <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
              ...
              <li class="flex items-center pr-2">
                ...
                <a dropdown-trigger href="javascript:;" class="block p-0 text-white transition-all text-sm ease-nav-brand" aria-expanded="false">
                  ...
                  <div class="cursor-pointer  ease-soft py-1.2 clear-both block w-full whitespace-nowrap rounded-lg bg-transparent px-4 duration-300 lg:transition-colors" 
                    aria-hidden="true"
                    id="profile"
      ...
      <div fixed-plugin-card class="z-sticky shadow-soft-3xl w-90 ease-soft -right-90 fixed top-0 left-auto flex h-full min-w-0 flex-col break-words rounded-none border-0 bg-white bg-clip-border px-2.5 duration-200">
        <div class="px-6 pt-4 pb-0 mb-0 bg-white border-b-0 rounded-t-2xl">
          <div class="float-left">
            <h5 class="mt-4 mb-0">Vue de ma page</h5>
            <p>Voir ci-dessous les Options</p>
          </div>
  ...
  <script src="{{ asset('/assets/js/mesJs.js') }}"></script>
  @yield('script')
</html>