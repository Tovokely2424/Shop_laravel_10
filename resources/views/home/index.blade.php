 <x-admin-layout title="Mon espace"> 
  <!-- Navbar -->
      <!-- cards -->
      @auth
      <div id="contenu" class="w-full px-6 py-6 mx-auto">
        <!-- row 1 -->
              ...
              <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-2/3 max-w-full px-3">
                    <div>
                      <p class="mb-0 font-sans text-sm font-semibold leading-normal">Vente ce jour</p>
